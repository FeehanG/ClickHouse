...
- `partition_id` (`String`) – Dd of the partition.
...
- `is_frozen` (`UInt8`) – Flag that shows a partition data backup exists. 1, the backup exists. 0, the backup doesn't exist. For more details, see [FREEZE PARTITION](../query_language/alter.md#alter_freeze-partition)
