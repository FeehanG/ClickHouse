...
This function [interprets](../../query_language/functions/type_conversion_functions.md#type_conversion_functions-reinterpretAsString) all the input parameters as strings and calculates the hash value for each of them. It then combines hashes.
...
Calculates JumpConsistentHash from UInt64.
...
- The `murmurHash2_32` function returns a [UInt32](../../data_types/int_uint.md) data type hash value.
- The `murmurHash2_64` function returns a [UInt64](../../data_types/int_uint.md) data type hash value.
...
A [FixedString(16) data type](../../data_types/fixedstring.md) hash value.
