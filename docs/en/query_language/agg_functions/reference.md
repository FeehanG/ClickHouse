...
Calculates the approximate number of different values for the argument.
...
Calculates the approximate number of different values for the argument, using the [HyperLogLog](https://en.wikipedia.org/wiki/HyperLogLog) algorithm.
